  ...
  <section class="section category-section">
    <div class="section_inner category-section__area">
      ...
      <div class="category category-section__area--select">
        ...
        <div class="category">
          <span class="category__box--title arrow-category">カテゴリー</span>
        ...
        <div class="archive">
          <span class="category__box--title arrow-archive"><?php echo get_the_date('Y.m'); ?></span>
          <ul class="category__box">
      ...
      <div class="category-section__area--contents">
        <div class="category">
          <div class="category-area contents-box">
            <?php if (have_posts()) : query_posts($query_string . '&posts_per_page=12paged=' . $paged);
